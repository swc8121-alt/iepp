...
IEPP emerged through a sequence of testable formulations rather than from a single confirmed premise. An earlier IEPP whitepaper, v0.3, was released in the public project repository as a preliminary technical report. It investigated whether challenge-bound commitments and runtime entropy produced distinguishable execution trajectories~\cite{seo2026v03}. It reported immediate fork divergence in 100 of 100 runs and no successes in 50,000 attempts across five implemented attacker cases. However, the original--fork statistical score gap was only 0.015. These observations supported trajectory instrumentation but did not establish original-copy discrimination or a general security theorem.
