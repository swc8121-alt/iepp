...
Table~1 summarizes the notation used in the protocol definition. The strings \texttt{IEPP-Entropy-v1} and \texttt{IEPP-State-vNext-1} are fixed ASCII protocol labels rather than mathematical variables. They provide domain separation so hashes created for different purposes or protocol versions cannot be silently interchanged. The latter is retained for compatibility with the current public reference implementation and is a constant input to the computation.
